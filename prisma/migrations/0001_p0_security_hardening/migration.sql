...
-- التطبيق: psql "$DIRECT_URL" -f prisma/migrations/0001_p0_security_hardening/migration.sql
--   أو من SQL Editor في Supabase، ثم: npx prisma migrate resolve --applied 0001_p0_security_hardening
